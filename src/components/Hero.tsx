...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-pink-50 via-white to-emerald-50">
      ...
      <div className="absolute bottom-32 right-16 animate-pulse delay-75">
        <Sparkles className="text-pink-300" size={24} />
      </div>
      <div className="absolute top-40 right-24 animate-pulse delay-150">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        <div className="mb-8 inline-block">
          <div className="relative">
            <div className="w-48 h-48 sm:w-64 sm:h-64 mx-auto rounded-full overflow-hidden border-4 border-amber-500 shadow-2xl">
              <img
            ...
            <div className="absolute -top-4 -left-4 w-8 h-8 sm:w-12 sm:h-12">
              <Sparkles className="text-amber-500 w-full h-full" />
            </div>
            <div className="absolute -bottom-4 -right-4 w-6 h-6 sm:w-10 sm:h-10">
              <Sparkles className="text-pink-400 w-full h-full" />
            </div>
          </div>
        </div>

        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif text-gray-800 mb-4">
          Whispered <span className="text-amber-600">Musings</span>
        </h1>
        ...
        <div className="flex justify-center space-x-12 text-center max-w-4xl mx-auto">
          <div className="flex-1">
            <div className="text-3xl font-serif text-amber-600 mb-2">Tarot</div>
            <p className="text-sm text-gray-600">Readings</p>
          </div>
          <div className="w-px bg-gray-300"></div>
          <div className="flex-1">
            <div className="text-3xl font-serif text-amber-600 mb-2">Spirit</div>
            <p className="text-sm text-gray-600">Paintings</p>
          </div>
          <div className="w-px bg-gray-300"></div>
          <div className="flex-1">
            <div className="text-3xl font-serif text-amber-600 mb-2">Intuitive</div>
